...
def test_selection_averages_all_p_values_and_exports_optimized_params(
    tmp_path: Path,
) -> None:
    ...
    csv_path, json_path = save_optimized_dm_params(rows, tmp_path)

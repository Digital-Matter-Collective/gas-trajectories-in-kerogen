...
Usage
-----
python scripts/powerlaw_analysis.py <path> --prefix SIB --mode xmin \\
       [--n_synth 500] [--n_xmin 30] [--step 1] [--seed 42]

python scripts/powerlaw_analysis.py <path> --prefix SIB --mode sample \\
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        choices=["DM", "SIB", "HYB"],
        help=(
            "Trap detection method prefix (default: SIB); must match a "
            "traps/<prefix> directory written by trap_distr_builder"
        ),
    )
    parser.add_argument(
        "--mode",

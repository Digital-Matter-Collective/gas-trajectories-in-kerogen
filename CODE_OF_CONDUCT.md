...
requests, discussions, and any other repository interactions), and also
...
reported by contacting the project maintainers through this repository on
GitHub — either by opening an issue, if the situation allows a public
report, or by messaging a maintainer directly through their GitHub profile
for a report that should stay private. All complaints will be reviewed and
